...
export const CS_POSITIONS_KEY = 'codetown-construction-positions'

interface ConstructionDevModeProps {
...
export default function ConstructionDevMode({
  elements,
  onElementsChange,
  onSave,
  onReset,
  containerRef,
}: ConstructionDevModeProps) {
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ top: 0, backgroundColor: '#facc15', color: '#1A1A1A', fontSize: '13px', fontWeight: 600 }}
      >
        <span>DEV: 拖中间移动，拖右下角缩放 (D 退出)</span>
        <button onClick={onSave} style={{ padding: '2px 12px', backgroundColor: '#16a34a', color: '#fff', borderRadius: 4, border: 'none', cursor: 'pointer', fontWeight: 700, fontSize: '12px' }}>
          定稿保存
        </button>
          ...
          >
            ...
            <div
              style={{
                ...
                width: 10, height: 10,
                backgroundColor: '#3385ff', border: '2px solid #fff',
